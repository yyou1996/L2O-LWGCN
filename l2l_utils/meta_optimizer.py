...
import math
from l2l_utils.utils import preprocess_gradients
from l2l_utils.layer_norm_lstm import LayerNormLSTMCell
from l2l_utils.layer_norm import LayerNorm1D
...
class MetaOptimizer(nn.Module):
    ...
    def meta_update(self, model_with_grads, loss):
        ...
        for module in [model_with_grads]:
            grads.append(module._parameters['weight'].grad.data.view(-1))
            grads.append(module._parameters['classifier'].grad.data.view(-1))
...
class FastMetaOptimizer(nn.Module):
    ...
    def meta_update(self, model_with_grads, loss):
        ...
        for module in [model_with_grads]:
            ...
            grads.append(module._parameters['classifier'].grad.data.view(-1).unsqueeze(-1))

        flat_params = self.meta_model.get_flat_params().unsqueeze(-1)
        flat_grads = torch.cat(grads)
        # print(flat_params.size(), 1)
        # print(flat_grads.size(), 2)

        self.i = self.i.expand(flat_params.size(0), 1)
        self.f = self.f.expand(flat_params.size(0), 1)
        # print(self.i.size(), self.f.size())
...
class MetaModel:
    ...
    def reset(self):
        for module in [self.model]:
            ...
            module._parameters['classifier'] = Variable(
                module._parameters['classifier'].data)
    ...
    def get_flat_params(self):
        ...
        for module in [self.model]:
            ...
            params.append(module._parameters['classifier'].view(-1))
    ...
    def set_flat_params(self, flat_params):
        ...
        for i, module in enumerate([self.model]):
            ...
            bias_shape = module._parameters['classifier'].size()
            ...
            module._parameters['classifier'] = flat_params[
